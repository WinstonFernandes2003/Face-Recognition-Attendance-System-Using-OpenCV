...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_label.grid(row=0,column=2,padx=5,pady=15)

        #combo box 
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,width=15,font=("verdana",12,"bold"),state="readonly")
        dep_combo["values"]=("Select Department","AI&DS","AI&ML","AU","CS","ISE","EC","EEE","MBA")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=3,padx=5,pady=15,sticky=W)
        ...
        cou_combo["values"]=("Select Course","BE/BTECH","MTECH","BEd","B.Sc","BSC")
        cou_combo.current(0)
