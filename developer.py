...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Python_Test_Projects\Images_GUI\an.jpg")
        ...
        std_b1_1 = Button(bg_img,text="Ahanija Narayana CH",cursor="hand2",font=("tahoma",11,"bold"),bg="white",fg="black")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"C:\Python_Test_Projects\Images_GUI\p2.jpg")
        ...
        det_b1_1 = Button(bg_img,text="Pranava Sharma K",cursor="hand2",font=("tahoma",11,"bold"),bg="white",fg="black")
        det_b1_1.place(x=480,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"C:\Python_Test_Projects\Images_GUI\p1.jpg")
        ...
        att_b1_1 = Button(bg_img,text="Prathviraj",cursor="hand2",font=("tahoma",11,"bold"),bg="white",fg="black")
        att_b1_1.place(x=710,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"C:\Python_Test_Projects\Images_GUI\m1.jpg")
        ...
        hlp_b1_1 = Button(bg_img,text="Winston Fernandes",cursor="hand2",font=("tahoma",11,"bold"),bg="white",fg="black")
